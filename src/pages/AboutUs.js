...
export default () => {
  return (
    ...
    <AnimationRevealPage>
    <Header/>
    <div className="h-full shadow-md bg-white absolute" style={{backgroundColor:'rgb(214,158,46)',width:'20%',color:'white'}}>
      {/* <ul class="relative">
        <li class="relative">
      ...
      <div className="offcanvas-header flex items-center m-3 relative" style={{justifyContent:'center',margin:'20px auto ',width:'45%'}}>
      ...
      <div className="offcanvas-body flex-grow p-4 overflow-y-auto relative" style={{color:'black'}}>
      ...
      {/* <div className="flex" style={{backgroundColor:'none',alignItems:'center',fontWeight:'bolder'}}>  
        <div style={{padding:'5px 0'}}>
          <img src="../../../images/screenlogo.png" style={{width:'15%',backgroundColor:'white',margin:'0 auto',padding:'5px'}}/>
        </div>
      ...
      {/* <div style={{borderRight:'3px solid green',backgroundColor:'rgb(12,63,116)',color:'white'}} className="offcanvas offcanvas-start fixed bottom-0 flex flex-col max-w-full bg-white invisible bg-clip-padding shadow-sm outline-none transition duration-300 ease-in-out text-gray-700 top-0 left-0 border-none w-96" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div className="offcanvas-body flex-grow p-4 overflow-y-auto" style={{backgroundColor:'white',color:'grey'}}>
      ...
      {/* <div id="carouselExampleCaptions" className="carousel slide relative" data-bs-ride="carousel">
        ...
        <div className="carousel-inner relative w-full overflow-hidden" style={{height:'800px'}}>
      ...
      {/* <div>
        <div className="p-5 px-9" style={{textAlign:'end',backgroundColor:'rgb(12,63,116)',color:'white'}}>
          <div style={{fontSize:'45px'}}>YOUNG SPRINGS (E-RYLA)</div>
          ...
          <div>
            <button className="px-5 py-2 rounded-full mt-3" type="button" style={{backgroundColor:'rgb(214,158,46)'}}>REGISTER NOW</button>
          </div>
        </div>
      </div> */}
