    ...
    {sites.map(item => {
        ...
        <div >
            <div style={{backgroundColor:'rgb(12,63,116)',color:'white',padding:'10px 0',display:'flex',justifyContent:'center'}}>
                <div style={{textAlign:'center',fontSize:'35px',margin:'0 auto'}}>
                ...
                <Link to={'/Appointment'}>
                    <div style={{marginRight:'20px',padding:'5px'}}>
                        ...
                        <button style={{display:'flex',alignItems:'center',background:'rgb(214,158,46)'}} className="px-3 py-1 rounded-md">
                            ...
                            <div style={{marginLeft:'10px'}}>Appointment</div>
                        </button>
                    </div>
                </Link>
            </div>
        ...
        <div style={{width:'100%'}}>
            <div style={{width:'70%',borderRadius:'15px',padding:'25px',flexWrap:'wrap',display:'flex',justifyContent:'end',margin:'0 auto'}}>
                
                
                <div className="text-center" style={{fontSize:'35px',margin:'auto',display:'flex'}}><b>User Profile</b></div>
                <div style={{display:'flex',textAlign:'center',justifyContent:'center',marginRight:'-15px'}}>
                    <div className="rounded-lg" style={{width:'20%',padding:'5px',border:'3px solid rgb(173,18,95)'}}>
                        <img src="../../../images/r4copy1.jpg" width="100%" className=""/>
                    </div>
                    <div style={{fontSize:'20px',background:'rgb(173,18,95)',padding:'25px',color:'white'}} className="rounded-lg">
                        <div className='mb-1' style={{display:'flex',alignItems:'center',justifyContent:'space-evenly'}}>
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="20.000000pt" height="20.000000pt" viewBox="0 0 256.000000 256.000000" preserveAspectRatio="xMidYMid meet">
                        ...
                        <div className='mb-1' style={{display:'flex',alignItems:'center',justifyContent:'space-evenly'}}>
                            <svg style={{marginRight:'4px'}} xmlns="http://www.w3.org/2000/svg" version="1.0" width="20.000000pt" height="20.000000pt" viewBox="0 0 256.000000 256.000000" preserveAspectRatio="xMidYMid meet">
        ...
        <div style={{display:'flex',justifyContent:'center',width:'100%'}}>
            <div style={{border:'2px solid rgb(12,63,116)',display:'flex',justifyContent:'center',width:'70%',borderRadius:'15px',padding:'25px',flexWrap:'wrap'}}>
                {item.data.sites.map(items =>
                    <div style={{background:'rgb(214,158,46)',width:'200px',height:'220px',color:'white',padding:'10px',margin:'15px'}} className="rounded-lg shadow-lg" key={items.id}>
                        <div>
                        ...
                        <div style={{float:'right'}}>{items.itemsite_desc}</div>
                    </div> 
                )}
            </div>
        </div>
